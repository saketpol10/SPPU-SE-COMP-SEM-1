...
{
    if(abs(600-i)<30 && abs(30-j)<30) {return true;}
    if(abs(30-i)<30 && abs(30-j)<30) {return true;}
    if(abs(600-i)<30 && abs(450-j)<30) {return true;}
    if(abs(30-i)<30 && abs(450-j)<30) {return true;}
    if(abs(315-i)<30 && abs(30-j)<30) {return true;}
    if(abs(315-i)<30 && abs(450-j)<30) {return true;}
    return false;
}
